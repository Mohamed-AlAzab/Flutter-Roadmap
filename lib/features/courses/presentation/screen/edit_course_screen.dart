...
class _EditCourseScreenState extends State<EditCourseScreen> {
  ...
  void initState() {
    super.initState();
    selectedPrerequisitesId = widget.course.prerequisites;
    courseTitleController.text = widget.course.title;
    courseDescriptionController.text = widget.course.description;
    courseNameController.text = widget.course.name;
    selectedIcon = widget.course.icon == 'null' ? null : widget.course.icon;
  }
